...
def _get_timeline(user_id):
    ...
    for post_id in posts:
        ...
        user_name=g.db.hget('user:' + str(post[b'user_id'], 'utf-8'), 'username')
        user_details=g.db.hgetall('user:' + str(post[b'user_id'], 'utf-8'))
        timeline.append(dict(
            user_name=user_name.decode(encoding="utf-8"),
            ts=post[b'ts'].decode(encoding="utf-8"),
            txt=post[b'text'].decode(encoding="utf-8")))
    return timeline
